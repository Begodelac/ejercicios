let letraNombre = {
   ...
   let nombre = window.prompt("Escribe el nombre del superhéroe");
   let fecha = window.prompt( "Escribe su fecha de nacimiento");
   let apellido = window.prompt( "Escribe su apellido");

   let primeraLetra = nombre.substring (0, 1);
   let ultimaApellido = apellido.substring(apellido.length -1);
   let fechaNacimiento = parseInt(fecha.substring(fecha.length-1));
