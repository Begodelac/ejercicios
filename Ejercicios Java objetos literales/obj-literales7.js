let sistemaSolar = {
 ...
 let planeta1 = window.alert(window.prompt("Escribe el nombre de un planeta del sistema solar").toLowerCase());
 let planeta2 = window.alert(window.prompt("Escribe el nombre de otro planeta del sistema solar").toLowerCase());
 let planeta3 = window.alert(window.prompt("Escribe el nombre de otro planeta del sistema solar").toLowerCase());

 If (sistemaSolar.mercurio.nombre === planeta1);{ 
    document.getElementById("div1").innerHTML = `
    <p>${sistemaSolar.mercurio}</p>
    `}